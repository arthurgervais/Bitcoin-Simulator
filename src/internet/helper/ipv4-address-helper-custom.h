...
#ifndef IPV4_ADDRESS_HELPER_CUSTOM_H
#define IPV4_ADDRESS_HELPER_CUSTOM_H
 ...
 * global problem.  Ipv4AddressHelperCustom is a simple class to make simple problems
 * easy to handle.
 *
 ...
 */
  Ipv4AddressHelperCustom (bool checkAddressDuplication = true);
 ...
 */
  Ipv4AddressHelperCustom (Ipv4Address network, Ipv4Mask mask, 
                           bool checkAddressDuplication = true, Ipv4Address base = "0.0.0.1");
...
private:
  ...
  bool     m_checkAddressDuplication; //!< disable or enable checking of address duplication (Ipv4AddressGenerator), default value = true
};

} // namespace ns3

#endif /* IPV4_ADDRESS_HELPER_CUSTOM_H */
